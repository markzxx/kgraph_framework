...
//    }
    ...
    unsigned nTrees = params.count("-t") ? stoi(params["-t"]) : 50;
    addRecord("tableNum", to_string(nTrees));
    unsigned mLevel = params.count("-b") ? stoi(params["-b"]) : 50;
    addRecord("bucketSize", to_string(mLevel));
